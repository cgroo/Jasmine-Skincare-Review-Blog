...
export const INITIAL_REVIEWS = [
  { id: 1, name: 'Barrier Repair Moisturiser', brand: 'CeraVe', cat: 'Moisturiser', rating: 5, emoji: '🧴', review: 'This has completely changed my skin. My dry patches are basically gone after a month of nightly use. Thick texture but sinks in beautifully — no greasiness at all.' },
  { id: 2, name: 'Invisible Sunscreen SPF 50+', brand: 'Ultra Violette', cat: 'SPF', rating: 4, emoji: '☀️', review: 'Finally an SPF that doesn\'t leave a white cast! Lightweight, no greasy residue, and my makeup sits on top perfectly.' },
  { id: 3, name: 'Snail Mucin Essence', brand: 'COSRX', cat: 'Serum', rating: 5, emoji: '✨', review: 'I was skeptical about snail mucin but this is genuinely incredible. My skin looks so plump and dewy after just two weeks.' },
